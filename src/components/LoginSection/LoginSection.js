...
import { useWallet } from '../../contexts/WalletContext'; // Updated path to use WalletContext
    ...
    return (
        <>
            <button className={styles.buttonStyle} onClick={toggleWalletDropdown}>
                <span>Wallet</span>
                <img src={walletSVG} alt="Wallet" style={{ width: '15px', marginLeft: '8px', verticalAlign: 'middle' }} />
            </button>
