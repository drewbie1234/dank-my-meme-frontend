...
const useContest = (contest) => {
    ...
    const voteForSubmission = useCallback(async (submissionIndex) => {
        ...
        try {
            ...
            try {
                const response = await axios.post('https://194.124.43.95:443/api/vote', {
    ...
    const submitMeme = useCallback(async (file, selectedAccount) => {
        ...
        try {
            ...
            const ipfsResponse = await axios.post('https://194.124.43.95:443/api/pinFile', formData, {
            ...
            const dbResponse = await axios.post('https://194.124.43.95:443/api/submissions', {
                contest,
